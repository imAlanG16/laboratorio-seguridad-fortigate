...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/topologia.png" alt="Topología de Red" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/interfaces_config.png" alt="Configuración de Interfaces" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/dhcp_config.png" alt="Servidor DHCP" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/ruta_estatica.png" alt="Ruta Estática" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/politica_http_servidores.png" alt="Política Usuarios a Servidores" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/politica_internet_general.png" alt="Política de Internet General" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/web_filter_config.png" alt="Configuración de Web Filter" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/application_control_config.png" alt="Control de Aplicaciones" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/dos_policy_config.png" alt="Política DoS" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/waf_policy_config.png" alt="Perfil WAF" width="480">
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/evidencia_bloqueo_redes.png" alt="Bloqueo Pinterest" width="280" style="margin-right: 10px;">
  <img src="images/evidencia_bloqueo_itla.png" alt="Bloqueo ITLA" width="280">
  <p><em>Figura 11: Pantallas de bloqueo en el cliente para Pinterest (izquierda) y el dominio itla.edu.do (derecha)</em></p>
</div>
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/evidencia_bloqueo_itla_logs.png" alt="Logs de Bloqueo ITLA" width="480">
  <p><em>Figura 12: Registro de logs del Web Filter mostrando el estado "blocked" para la petición de itla.edu.do</em></p>
</div>
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/evidencia_nmap_ataque.png" alt="Ejecución de Nmap" width="280" style="margin-right: 10px;">
  <img src="images/evidencia_nmap_bloqueo.png" alt="Logs DoS" width="280">
  <p><em>Figura 13: Escaneo de Nmap con pérdida de paquetes en el host cliente (izquierda) y registros DoS correspondientes en el FortiGate (derecha)</em></p>
</div>
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
  <img src="images/evidencia_waf_bloqueo.png" alt="Bloqueo de WAF en Navegador" width="480">
  <p><em>Figura 14: Mensaje de bloqueo del Web Application Firewall al interceptar el intento de inyección de directorios</em></p>
</div>
